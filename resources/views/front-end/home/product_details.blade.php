                        ...
                        <div clas="single-top">
                                ...
                                <div class="single-left">
                                    <div class="flexslider">
                                        <ul class="slides">
                                            @foreach($dropzone as $dropzones)


                                            <li data-thumb="{{ asset($dropzones->photo) }}">
                                                <div class="thumb-image"> <img src="{{ asset($dropzones->photo) }}" height="60px" width="60px" data-imagezoom="true" class="img-responsive"> </div>
                                            </li>
                                            @endforeach
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">Tk. {{ $product_details->product_price }}</p>
                                <div class="description">
                                    <p><span>Quick Overview : </span> {{ $product_details->short_description }}</p>
                                </div>


                               {!! Form::open(['route'=>'shopping-cart' , 'method'=>'post']) !!}
                                    ...
                                    <div class="women">
                                       {{--<span class="size">XL / XXL / S </span>--}}
                                        {{--<input type="submit" data-text="Add To Cart" class="my-cart-b item_add" value="Add To Cart">--}}
                                   <input type="submit" name="add_to_cart" class="my-cart-b item_add" value="Add To Cart">
                                    </div>
                                {!! Form::close() !!}
