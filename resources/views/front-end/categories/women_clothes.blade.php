                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div class="product-tab">
                                            ...
                                            @foreach($womenClothes as $womenClothe)
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details', ['id'=>$womenClothe->id]) }}" class="new-gri"  data-target="#myModal1">
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($womenClothe->product_image) }}" height="200px" width="150px"  alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($womenClothe->product_image) }}" height="200px" width="150px"  alt="">
                                                                </div>
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="{{ route('product-details', ['id'=>$womenClothe->id]) }}">{{ $womenClothe->product_name }}</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p ><em class="item_price">Tk. {{ $womenClothe->product_price }}</em></p>
                                                        <a href="{{ route('product-details', ['id'=>$womenClothe->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        ...
                                        <div class="product-tab1">
                                                    ...
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($womenClothe->product_image) }}"height="200px" width="150px" c alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($womenClothe->product_image) }}"height="200px" width="150px"   alt="">
                                                                </div>
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                ...
                                                <div class="women">
                                                    <h6><a href="single.html">{{ $womenClothe->product_name }}</a></h6>
                                                    <span class="size">XL / XXL / S </span>
                                                    <p>{{ $womenClothe->short_description }}</p>
                                                    <p ><em class="item_price">Tk. {{ $womenClothe->product_price }}</em></p>
