...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="{{ asset('/') }}dashboard/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="{{ asset('/') }}dashboard/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('/home/createCategory') }}">Create Category</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('multiple-photo-upload') }}">multiple photo upload</a>
                            </li>
                            <li>
                                {{--<a href="{{ route('manage-category') }}">Manage Category</a>--}}
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Manage order<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
						...
						<li>
                        <a href="{{ route('/home/tables') }}"><i class="fa fa-table fa-fw"></i> Tables</a>
                    </li>
                    <li>
                        <a href="{{ route('/home/forms') }}"><i class="fa fa-edit fa-fw"></i> Forms</a>
                    </li>
                    <li>
...
{{--<script src="{{ asset('/') }}dashboard/dropjone/dropzone.js"></script>--}}
...
<script>
    ...
    <script src="{{ asset('/') }}dashboard/metisMenu/metisMenu.min.js"></script>

    <!-- DataTables JavaScript -->
    <script src="{{ asset('/') }}dashboard/datatables/js/jquery.dataTables.min.js"></script>
    <script src="{{ asset('/') }}dashboard/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="{{ asset('/') }}dashboard/datatables-responsive/dataTables.responsive.js"></script>
