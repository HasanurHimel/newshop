                    ...
                    <div class="containerr">
                        ...
                        <div class="company-contact">
                            ...
                            <div class="email right">
                                ...
                                <a href="#">habibadnan6854@gmail.com</a>
                                <span class="helper"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="containerr">
                        <div class="details clearfix">
                            <div class="client left">
                                <h3>Billing info</h3>
                                <p class="name">{{ $customer->first_name.' '.$customer->last_name }}</p>
                                <a href="mailto:john@example.com">{{ $customer->email }}</a>
                                <p>Mo:{{ $customer->mobile }}</p>
                                <p>{{ $customer->address }}</p>

                            </div>
                            <div class="client right">
                                <p>Shipping info</p>
                                <p class="name">{{ $shipping->full_name }}</p>
                                <a href="mailto:john@example.com">{{ $shipping->email }}</a>
                                <p>Mo: {{ $shipping->mobile }}</p>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <th class="sl text-center">Sl: </th>
                                <th class="qty text-center">Product name</th>
                                <th class="unit text-center">Price</th>
                                <th class="total text-center">Photo</th>
                                <th class="total text-center">Quantity</th>
                            ...
                            <tr>
                                <td class="sl text-center"><h3>{{ $i++ }}</h3></td>
                                <td class="qty text-center">{{ $orderDetail->product_name }}</td>
                                <td class="unit text-center">{{ $orderDetail->product_price }} .Tk</td>
                                <td class="total text-center">Empty</td>
                                <td class="total text-center">{{ $orderDetail->product_quantity }}</td>
                                <td class="total text-center">{{ $total=$orderDetail->product_quantity*$orderDetail->product_price }} .Tk</td>
                            </tr>
                        ...
                        <div class="no-break">
                            <table class="grand-total">
                                ...
                                <tr>
                                    <td class="desc"></td>
                                    <td class="qty"></td>
                                    <td class="unit text-center">SUBTOTAL:</td>
                                    <td class="total text-center">{{ $total }} .Tk</td>
                                </tr>
                                <tr>
                                    <td class="desc"></td>
                                    <td class="qty"></td>
                                    <td class="unit text-center">TAX 25%:</td>
                                    <td class="total text-center">0</td>
                                </tr>
                                <tr>
                                    <td class="desc"></td>
                                    <td class="qty"></td>
                                    <td class="unit text-center">Delivery charge</td>
                                    <td class="total text-center">90 .Tk</td>
                                </tr>
                                <tr>
                                    <td class="desc"></td>
                                    <td class="unit text-center" colspan="2">GRAND TOTAL:</td>
                                    <td class="total text-center">{{ $grandTotal+90 }} .Tk</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
